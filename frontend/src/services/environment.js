export const environment = {
    ...
    TARGET_TABLE_URL: process.env.NODE_ENV === 'production' ? 'http://34.76.46.230:8100/v1/api/omopTable/' : 'http://localhost:8100/v1/api/omopTable/',
    TARGET_FIELD_URL: process.env.NODE_ENV === 'production' ? 'http://34.76.46.230:8100/v1/api/omopField/' : 'http://localhost:8100/v1/api/omopField/',
    SOURCE_TABLE_URL: process.env.NODE_ENV === 'production' ? 'http://34.76.46.230:8100/v1/api/ehrTable/' : 'http://localhost:8100/v1/api/ehrTable/',
    SOURCE_FIELD_URL: process.env.NODE_ENV === 'production' ? 'http://34.76.46.230:8100/v1/api/ehrField/' : 'http://localhost:8100/v1/api/ehrField/',
