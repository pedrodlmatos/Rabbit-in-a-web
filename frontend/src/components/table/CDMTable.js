...
class CDMTable extends Component {
    ...
    render() {
        return(
            <div id={this.state.table.id} className={this.state.clicked ? "targetTableRectangleSelected" : "targetTableRectangle" } onClick={ () => this.selectTargetTable(this.state.table) }>
