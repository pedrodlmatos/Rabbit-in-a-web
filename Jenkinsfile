        ...
        stage('Docker registry push') {
            ...
            parallel {
                stage('Backend project') {
                    steps {
                        sh '''
                            docker tag hiah-backend 35.233.0.56:5000/v2/hiah-backend:runtime
                            docker push 35.233.0.56:5000/v2/hiah-backend:runtime
                        '''
                    }
                }
                ...
                stage('Frontend project') {
                    steps {
                        sh '''
                            docker tag hiah-frontend 35.233.0.56:5000/v2/hiah-frontend:runtime
                            docker push 35.233.0.56:5000/v2/hiah-frontend:runtime
                        '''
                    }
                }
            }
